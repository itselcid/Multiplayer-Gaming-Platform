                ...
                <div class="relative z-10 px-10 py-8">
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center text-xs uppercase">
                            <span class="px-3 text-white/40 font-['Zen_Dots',sans-serif] text-[9px]" style="background: linear-gradient(135deg, rgba(10, 22, 40, 0.9) 0%, rgba(30, 11, 61, 0.9) 100%);">or</span>
                        </div>
                    </div>
