...
export class Tournament_card extends Component {
	...
	render(): void {
		...
		const	join_tournament = addElement('Button', 'block w-full py-3 rounded-lg text-center font-bold transition-all bg-neon-cyan text-space-dark hover:shadow-lg hover:shadow-neon-cyan/50', this.el);
