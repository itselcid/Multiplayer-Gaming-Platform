...
export class ConnectWallet extends Component {
	...
	render(): void {
		...
		content.insertAdjacentHTML('beforeend', `
				...
				`);
		const	connect_button = addElement('button', 'w-full m-4 px-8 py-4 rounded-lg bg-neon-cyan text-space-dark font-bold text-lg hover:shadow-2xl hover:shadow-neon-cyan/50 transition-all transform hover:scale-105', content);
