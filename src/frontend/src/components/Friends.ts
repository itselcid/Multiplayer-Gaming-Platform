...
export class Friends extends Component {
  ...
  render() {
    ...
    this.el.innerHTML = `
      <div class="h-[82vh] bg-black/60 border border-neon-cyan/20 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-md flex flex-col" style="background: linear-gradient(135deg, rgba(10, 22, 40, 0.85) 0%, rgba(10, 30, 60, 0.85) 100%);  inset 0 0 30px rgba(0, 217, 255, 0.05);">
