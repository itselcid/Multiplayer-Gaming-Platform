...
/*   Updated: 2026/01/31 16:28:07 by kez-zoub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class Navbar extends Component {
  ...
  render() {
	...
	const auth_connect = addElement('div', '', auth);
	auth_connect.id = 'auth-connect';
	...
	const authMobile_connect = addElement('div', '', authMobile);
	authMobile_connect.id = 'authMobile-connect';
