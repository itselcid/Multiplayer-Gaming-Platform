...
//   Updated: 2025/11/09 01:20:17 by kez-zoub         ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
export class Error_wallet_connection extends Component {
	...
	render(): void {
		...
		<div class="fixed inset-0 z-10 bg-black/40 backdrop-blur-sm overflow-y-auto overscroll-y-auto no-scrollbar flex justify-center  items-start">



        <div class="max-w-lg w-full relative z-10" style="animation: fadeIn 0.5s ease-out">
          <div class="relative">
            <div class="absolute inset-0 bg-gradient-to-r from-red-500/10 to-rose-500/10 rounded-3xl blur-xl"></div>
            
            <div class="relative bg-slate-900/80 backdrop-blur-2xl rounded-3xl p-12 border border-red-500/20 shadow-2xl my-8">
              ...
              <div class="bg-red-950/30 rounded-xl p-5 border border-red-500/30 mb-8">
                <div class="flex items-start space-x-4">
                  ...
                  <div class="flex-1">
                    <h3 class="text-red-300 font-semibold text-sm mb-1.5">Connection Failed</h3>
              ...
              <div class="space-y-3">
                ...
                <button
                  class="w-full bg-slate-800/60 hover:bg-slate-800 text-slate-300 hover:text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 border border-slate-700"
                >
                  Return to Home
                </button>
              </div>
